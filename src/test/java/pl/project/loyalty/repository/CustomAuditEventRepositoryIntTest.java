package pl.project.loyalty.repository;

import pl.project.loyalty.LoyaltyApp;
import pl.project.loyalty.config.Constants;
import pl.project.loyalty.config.audit.AuditEventConverter;
import pl.project.loyalty.domain.PersistentAuditEvent;
...
import static pl.project.loyalty.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
